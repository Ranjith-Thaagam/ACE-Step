...
# ✅ ADD THIS: Import your Tamil tokenizer
import sys
sys.path.append(os.path.join(os.path.dirname(__file__), 'src'))
from tokenizer.tokenizer import TamilTokenizerWrapper
...
class Pipeline(LightningModule):
    def __init__(
        ...
        if self.is_train:
            ...
            try:
                ...
                # ✅ FIX: json is already imported at the top
    ...
    # ✅ MODIFIED: Updated get_text_embeddings to use Tamil tokenizer
    def get_text_embeddings(self, texts, device, text_max_length=256):
        # Use your Tamil tokenizer instead of the default one
...
def main(args):
    ...
    # ✅ FIX: Use single GPU strategy instead of DDP
    trainer = Trainer(
        accelerator="gpu",
...
if __name__ == "__main__":
    ...
    args.add_argument("--exp_name", type=str, default="tamil_lora_v1")
    args.add_argument("--precision", type=str, default="32")
    args.add_argument("--accumulate_grad_batches", type=int, default=1)
    args.add_argument("--devices", type=int, default=1)  # Changed to 1
    ...
    args.add_argument("--lora_config_path", type=str, default="config/tamil_lora_simple_safe.json")
